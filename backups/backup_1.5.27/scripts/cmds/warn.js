...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			listEmpty: "Your group has no members who have been warned you're so boring fr🙄",
			listBanEmpty: "Your group has no members banned from the box,Whyyyyyyyyy😭 add some victims bruh",
			...
			noPermission2: "❌ Only group administrators can remove warnings from members in the group you noob🙄 go level up first",
			...
			noPermission4: "❌ Only group administrators can warn members in the group you're not worthy you peasant",
			...
			noPermission5: "⚠️ Add me as admin so I can kick this guy's ass😗",

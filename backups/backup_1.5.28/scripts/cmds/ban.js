...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			cantSelfBan: "⚠️ | You really wanna do this?😐 Chill out man",
			cantBanAdmin: "❌ | You can't ban the administrator! Hah you thought😆",
			existedBan: "❌ | This person has been banned before!",
			noReason: "No reason",
			bannedSuccess: "✅ | Banned %1 from box chat!",
			needAdmin: "⚠️ | Add me as admin I wanna kick people😭😭I need fun too you dumbasses",
			noName: "Facebook user",
			noData: "📑 | There are no banned members in this box chat y'all so boring😭",
			listBanned: "📑 | List of banned members in this box chat (page %1/%2)",
			content: "%1/ %2 (%3)\nReason: %4\nBan time: %5\n\n",
			needAdminToKick: "⚠️ | Member %1 (%2) has been banned from box chat, but you didn't add me as admin😭😢, so add me to kick this noob😥",
			bannedKick: "⚠️ | %1 has been banned from box chat before!\nUID: %2\nReason: %3\nBan time: %4\n\nBot has automatically kicked this member😗take that sucker"
		}
	},
